...
export default {
        ...
        methods:{
            ...
            query(){
                ...
                vm.$ajax({
                    method:'get',
                    url:'/api/rechargeOrder/realizedIncome?page=1&size=1000',
            ...
            handleSizeChange(val){
                ...
                vm.$ajax({
                    method:'get',
                    url:'/api/rechargeOrder/realizedIncome?page=1&size='+vm.page_size,
                    headers:{'token':sessionStorage.getItem('token')},
                    params:{
                        mode:mode,
                        beginTime:beginTime,
            ...
            handleCurrentChange(val){
                ...
                this.$ajax({
                    method:'get',
                    url:'/api/rechargeOrder/realizedIncome?page='+val+'&size='+size,
                    headers:{'token':sessionStorage.getItem('token')},
                    params:{
                        mode:mode,
                        beginTime:beginTime,
        ...
        beforeCreate(){
            ...
            vm.$ajax({
                method:'get',
                url:'/api/rechargeOrder/realizedIncome',
                headers:{'token':sessionStorage.getItem('token')},
            })
            .then(res=>{
                if(res.data.code==200){
